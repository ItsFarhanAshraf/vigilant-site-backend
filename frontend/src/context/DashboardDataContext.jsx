...
const INITIAL_HOUSES = [
  {
    ...
    remainingLoan: 0,
    loanStatus: 'Completed (2/2 Tranches Disbursed)',
    engineerId: 1,
  ...
  },
  {
    ...
    loanStatus: 'Approved - Pending 1st Tranche (PKR 750k)',
    engineerId: 3,
    engineerName: 'Ayesha Mir',
    safetyStatus: 'Safe',
    safetyIssuesCount: 0,
...
const INITIAL_LOANS = [
  {
    ...
    remainingAmount: 0,
    tranches: [
      { trancheNo: 1, stage: 'Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-01-20', voucherRef: 'BOP-TXN-88192' },
      { trancheNo: 2, stage: '50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Disbursed', date: '2026-04-15', voucherRef: 'BOP-TXN-90214' },
    ],
    status: 'Completed',
  ...
  },
  {
    ...
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-02-15', voucherRef: 'BOP-TXN-89012' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending 50% Inspection', date: null, voucherRef: null },
    ],
    status: 'Active',
  ...
  },
  {
    ...
    remainingAmount: 750000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-03-05', voucherRef: 'BOP-TXN-89510' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending 50% Inspection', date: null, voucherRef: null },
    ],
    status: 'Active',
  ...
  },
  {
    ...
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Approved for Disbursement', date: null, voucherRef: null },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Upcoming', date: null, voucherRef: null },
    ],
    status: 'Approved',
  ...
  },
  {
    ...
    remainingAmount: 1500000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Pending Application Approval', date: null, voucherRef: null },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Upcoming', date: null, voucherRef: null },
    ],
  ...
  {
    id: 'LN-2026-006',
    applicant: 'Ghulam Rasool',
    cnic: '34101-5678901-9',
    houseId: 'ACAG-G-2567',
    division: 'Gujranwala',
    approvedAmount: 1500000,
    disbursedAmount: 750000,
    remainingAmount: 750000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-03-20', voucherRef: 'BOP-TXN-89871' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending Safety Clearance', date: null, voucherRef: null },
    ],
    status: 'Active',
    appliedDate: '2026-03-01',
    bank: 'Bank of Punjab (BOP)',
    accountNo: 'PK82BPUN0066192837482',
  },
  {
    id: 'LN-2026-007',
    applicant: 'Farooq Qureshi',
    cnic: '36302-1234567-7',
    houseId: 'ACAG-M-0934',
    division: 'Multan',
    approvedAmount: 1500000,
    disbursedAmount: 1500000,
    remainingAmount: 0,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-01-15', voucherRef: 'BOP-TXN-88045' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Disbursed', date: '2026-04-20', voucherRef: 'BOP-TXN-90455' },
    ],
    status: 'Completed',
    appliedDate: '2026-01-05',
    bank: 'Bank of Punjab (BOP)',
    accountNo: 'PK82BPUN0055192837491',
  },
  {
    id: 'LN-2026-008',
    applicant: 'Abdul Sattar',
    cnic: '31202-6789012-3',
    houseId: 'ACAG-B-3109',
    division: 'Bahawalpur',
    approvedAmount: 1500000,
    disbursedAmount: 750000,
    remainingAmount: 750000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-04-05', voucherRef: 'BOP-TXN-90112' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending 50% Inspection', date: null, voucherRef: null },
    ],
    status: 'Active',
    appliedDate: '2026-04-01',
    bank: 'Bank of Punjab (BOP)',
    accountNo: 'PK82BPUN0044192837412',
  },
  {
    id: 'LN-2026-009',
    applicant: 'Imran Ashraf',
    cnic: '35102-8901234-7',
    houseId: 'ACAG-K-5501',
    division: 'Lahore',
    approvedAmount: 1500000,
    disbursedAmount: 750000,
    remainingAmount: 750000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-02-20', voucherRef: 'BOP-TXN-89230' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending 50% Inspection', date: null, voucherRef: null },
    ],
    status: 'Active',
    appliedDate: '2026-02-14',
    bank: 'Bank of Punjab (BOP)',
    accountNo: 'PK82BPUN0033192837423',
  },
  {
    id: 'LN-2026-010',
    applicant: 'Shahid Iqbal',
    cnic: '35302-9012345-9',
    houseId: 'ACAG-P-6612',
    division: 'Sahiwal',
    approvedAmount: 1500000,
    disbursedAmount: 750000,
    remainingAmount: 750000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-03-01', voucherRef: 'BOP-TXN-89450' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending 50% Inspection', date: null, voucherRef: null },
    ],
    status: 'Active',
    appliedDate: '2026-02-20',
    bank: 'Bank of Punjab (BOP)',
    accountNo: 'PK82BPUN0022192837434',
  },
  {
    id: 'LN-2026-011',
    applicant: 'Waqas Munir',
    cnic: '34601-2233445-7',
    houseId: 'ACAG-S-9911',
    division: 'Gujranwala',
    approvedAmount: 1500000,
    disbursedAmount: 750000,
    remainingAmount: 750000,
    tranches: [
      { trancheNo: 1, stage: '1st Tranche: Initial Phase (Foundation & Mobilization)', amount: 750000, status: 'Disbursed', date: '2026-03-10', voucherRef: 'BOP-TXN-89670' },
      { trancheNo: 2, stage: '2nd Tranche: 50% Construction Milestone (Roof Slab & Finishing)', amount: 750000, status: 'Pending 50% Inspection', date: null, voucherRef: null },
    ],
    status: 'Active',
    appliedDate: '2026-02-25',
    bank: 'Bank of Punjab (BOP)',
    accountNo: 'PK82BPUN0011192837445',
  }
];
